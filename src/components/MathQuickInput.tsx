...
const symbols = [
  { label: '∞', latex: '∞', unicode: '∞', tooltip: 'Infinity' },
  { label: 'π', latex: 'π', unicode: 'π', tooltip: 'Pi' },
  { label: '°', latex: '°', unicode: '°', tooltip: 'Degrees' },
  { label: '≤', latex: '≤', unicode: '≤', tooltip: 'Less than or equal' },
  { label: '≥', latex: '≥', unicode: '≥', tooltip: 'Greater than or equal' },
  { label: '≠', latex: '≠', unicode: '≠', tooltip: 'Not equal' },
  { label: '±', latex: '±', unicode: '±', tooltip: 'Plus/Minus' },
  { label: '×', latex: '×', unicode: '×', tooltip: 'Multiply' },
  { label: '÷', latex: '÷', unicode: '÷', tooltip: 'Divide' },
  { label: '→', latex: '→', unicode: '→', tooltip: 'Right arrow' },
  { label: '←', latex: '←', unicode: '←', tooltip: 'Left arrow' },
  { label: '↑', latex: '↑', unicode: '↑', tooltip: 'Up arrow' },
  { label: '↓', latex: '↓', unicode: '↓', tooltip: 'Down arrow' },
  { label: '↔', latex: '↔', unicode: '↔', tooltip: 'Left-right arrow' },
  { label: '⇌', latex: '⇌', unicode: '⇌', tooltip: 'Equilibrium arrow' },
  { label: '∈', latex: '∈', unicode: '∈', tooltip: 'Element of' },
  { label: '∪', latex: '∪', unicode: '∪', tooltip: 'Union' },
  { label: '∩', latex: '∩', unicode: '∩', tooltip: 'Intersection' },
  { label: 'θ', latex: 'θ', unicode: 'θ', tooltip: 'Theta' },
  { label: 'α', latex: 'α', unicode: 'α', tooltip: 'Alpha' },
  { label: 'β', latex: 'β', unicode: 'β', tooltip: 'Beta' },
